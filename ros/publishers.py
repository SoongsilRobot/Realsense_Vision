...
class Publishers:
    ...
    def __init__(self, node: Node, image_topic: str, dist_topic: str):
        ...
        self.pub_dist = node.create_publisher(Float32MultiArray, dist_topic, 10)
    ...
    def publish_distance_m(self, dist_m: float, cx: float, cy: float) -> None:
        msg = Float32MultiArray()
        msg.data = [float(dist_m), float(cx), float(cy)]  # [distance, x, y]
